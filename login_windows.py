...
def sign_in():
    ...
    subgroup_menu = ttk.OptionMenu(sign_in_window, subgroup_var, "Select", "Infants", "Children", "Adult", "Pregnancy",
                                   "Lactation")
    ...
    activity_level_menu = ttk.OptionMenu(sign_in_window, activity_level_var, "Select", "Sedentary", "Lightly active",
